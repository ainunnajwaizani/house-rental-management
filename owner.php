...
{
 echo "<tr><td>".$result['o_id']."</td><td>".$result['name']."</td><td>".$result['email']."</td><td>".$result['mobile_no']."</td><td>".$result['account_no']."</td><td>".$result['no_of_houses']."</td><td>".$result['address']."</td><td>";
